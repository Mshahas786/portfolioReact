  ...
  return (
      ...
      <div className="container shadow-lg h-75">
        <div className="row h-100">
          ...
          transition={{ delay: .1 }}
          className="col-1 col-lg-3 p-0  bg-success ">
            <motion.img 
          ...
          animate={{ x:0, scale:1, opacity: 1 }}
          transition={{ delay: .2 }}
          className="col-11 col-lg-8 d-flex align-items-center bg-danger overflow-auto p-0 pl-2">
            <motion.h1
            initial={{ x:-100, opacity: 0 }}
            animate={{ x:0, opacity: 1 }}
            transition={{ delay: .5 }}
             className=" text-white  mt-5  " style={{fontFamily:'Pattaya', fontSize:'4rem'}}>
              Hello,<br/> I'm Muhammed<br/> The Front-end Developer.
            </motion.h1>
